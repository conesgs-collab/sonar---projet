...
if ($AddRepairMenu) {
    ...
    $menuLines = @(
        ...
        "rem cmd.exe s'est averee ne PAS matcher deux chaines de 64 caracteres pourtant identiques (confirme"
        "rem par une comparaison PowerShell independante -eq renvoyant True sur les 2 memes valeurs, VM,"
        "rem 2026-09-23 - cause exacte non identifiee malgre plusieurs heures de diagnostic instrumente,"
